...
class Rv2Spider(CrawlSpider):
    ...
    To start extracting data:
        ...
        * scrapy crawl -o FILENAME.FILETYPE -t FILETYPE rv2

    """
    handle_httpstatus_list = [503]
    DOWNLOADER_MIDDLEWARES = {
            'scrapy.contrib.downloadermiddleware.retry.RetryMiddleware': 300,
            'myspider.comm.random_proxy.RandomProxyMiddleware': 503,
    }
    ...
    def parse_item(self, response):
        ...
        for rev in range(len(review_list)):
            ...
            i['Rating'] = int(float(soup.find('span', { "class" : "a-icon-alt" }).get_text()[:3]))
